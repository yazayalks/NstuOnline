...
namespace NstuOnline.EducationalStructureService.Application.Extensions;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Nstu Online EducationalStructure Service API", Version = "v1" });
        });
    }
}