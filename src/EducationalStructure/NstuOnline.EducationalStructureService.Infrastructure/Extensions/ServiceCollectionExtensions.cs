...
namespace NstuOnline.EducationalStructure.Infrastructure.Extensions;
...
public static class ServiceCollectionExtensions
{
    ...
    {
        services.AddDbContext<EducationalStructureContext>(options =>
            options.UseNpgsql(configuration.GetConnectionString(nameof(EducationalStructureContext))));

        services
            .AddRepositoryReferences()
            .AddOpenTelemetryReferences("NstuOnline.EducationalStructureService");
