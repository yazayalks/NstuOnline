...
namespace NstuOnline.EventService.Infrastructure.Extensions;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        services.AddDbContext<EventContext>(options =>
            options.UseNpgsql(configuration.GetConnectionString(nameof(EventContext))));

        services
            .AddRepositoryReferences()
            .AddOpenTelemetryReferences("NstuOnline.EventService");
