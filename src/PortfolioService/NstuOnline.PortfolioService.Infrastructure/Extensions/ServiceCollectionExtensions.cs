...
namespace NstuOnline.PortfolioService.Infrastructure.Extensions;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        services.AddDbContext<PortfolioContext>(options =>
            options.UseNpgsql(configuration.GetConnectionString(nameof(PortfolioContext))));

        services
            .AddRepositoryReferences()
            .AddOpenTelemetryReferences("NstuOnline.PortfolioService");
